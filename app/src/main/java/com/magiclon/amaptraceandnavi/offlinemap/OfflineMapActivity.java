package com.magiclon.amaptraceandnavi.offlinemap;
...
import com.magiclon.amaptraceandnavi.R;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case UPDATE_LIST:
                    ...
                    break;
                case SHOW_MSG:
                    com.magiclon.individuationtoast.ToastUtil.showinfo(OfflineMapActivity.this, (String) msg.obj);
                    break;
        ...
        switch (status) {
            ...
            case OfflineMapStatus.EXCEPTION_NETWORK_LOADING:
                Log.e("amap-download", "download: " + " EXCEPTION_NETWORK_LOADING "
                        + downName);
                com.magiclon.individuationtoast.ToastUtil.showerror(OfflineMapActivity.this, "网络异常");
                amapManager.pause();
                break;
